...
namespace WallShields
{
    class LaserGridEmitterComp : ThingComp
    {
        ...
        {
            gridCells.Clear();
            IntVec3 direction = IntVec3.North.RotatedBy(parent.Rotation);
            IntVec3 vecFacing = parent.Position + IntVec3.North.RotatedBy(parent.Rotation); //This should be the tile in front of us
